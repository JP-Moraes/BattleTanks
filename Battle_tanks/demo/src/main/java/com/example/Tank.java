...
import com.example.ENUMS.TankStatus;
...
public abstract class Tank {
    ...
    public void TankRegister() {
        System.out.println("Tank Codename: " + codename);
        System.out.println("Tank ID: " + id);
        System.out.println("Class Type: " + classType);
        System.out.println("Pilot Type: " + pilotType);
        System.out.println("Shield: " + shield);
        System.out.println("Integrity: " + integrity);
        if (weapon != null) {
            System.out.println("Weapon Module: " + weapon);
        } else {
            System.out.println("No Weapon Module assigned.");
            }
